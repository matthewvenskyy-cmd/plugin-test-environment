...
export async function run(ctx) {
  ...
  const defaultSpeed = await queryPlayerAttribute(ctx, "HeavySpeed", "minecraft:movement_speed");
  ...
  const heavySpeed = await queryPlayerAttribute(ctx, "HeavySpeed", "minecraft:movement_speed");
  ...
  const resetSpeed = await queryPlayerAttribute(ctx, "HeavySpeed", "minecraft:movement_speed");
