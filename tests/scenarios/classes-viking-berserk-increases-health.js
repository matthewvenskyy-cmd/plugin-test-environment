...
export async function run(ctx) {
  ...
  const before = await queryPlayerAttribute(ctx, "BerserkViking", "minecraft:max_health");
  ...
  await wait(750);
  const after = await queryPlayerAttribute(ctx, "BerserkViking", "minecraft:max_health");
