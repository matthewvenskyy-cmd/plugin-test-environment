...
const RIDER_FLOOR = new Vec3(224, 79, -2);
const SEAT_FLOOR = new Vec3(224, 79, 2);
...
export async function run(ctx) {
  ...
  try {
    ...
    await command("fill 223 79 -3 225 79 2 minecraft:stone", 500);
    ...
    await command("tp MCorebreak 224 80 -2 0 0", 500);
    await command("tp MCoreSeat 224 80 2 180 0", 500);
    ...
    await command("effect give MCorebreak minecraft:slow_falling 30 1 true", 250);
    await command("effect give MCoreSeat minecraft:slow_falling 30 1 true", 250);
    ...
    await command("fill 223 79 -3 225 79 2 minecraft:air", 500);
